...
#include <stddef.h>
#include "blas.h"
#include "OptimalMPCInput_mdl_sfun.h"
#include "c2_OptimalMPCInput_mdl.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "OptimalMPCInput_mdl_sfun_debug_macros.h"
...
static void initialize_c2_OptimalMPCInput_mdl
  (SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance);
static void initialize_params_c2_OptimalMPCInput_mdl
  (SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance);
static void enable_c2_OptimalMPCInput_mdl(SFc2_OptimalMPCInput_mdlInstanceStruct
  *chartInstance);
static void disable_c2_OptimalMPCInput_mdl
  (SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_OptimalMPCInput_mdl
  (SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_OptimalMPCInput_mdl
  (SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance);
static void set_sim_state_c2_OptimalMPCInput_mdl
  (SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_OptimalMPCInput_mdl
  (SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance);
static void sf_c2_OptimalMPCInput_mdl(SFc2_OptimalMPCInput_mdlInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_OptimalMPCInput_mdl
  (SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance);
static void initSimStructsc2_OptimalMPCInput_mdl
  (SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance);
static void registerMessagesc2_OptimalMPCInput_mdl
  (SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_OptimalMPCInput_mdlInstanceStruct
  *chartInstance, const mxArray *c2_flag_oob, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_OptimalMPCInput_mdlInstanceStruct
...
static const mxArray *c2_h_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_OptimalMPCInput_mdlInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[3]);
...
static const mxArray *c2_i_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_OptimalMPCInput_mdlInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[1000]);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_e_emlrt_marshallIn(SFc2_OptimalMPCInput_mdlInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[300]);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[26]);
static void c2_round(SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance,
                     real_T c2_x[3], real_T c2_b_x[3]);
static void c2_eml_scalar_eg(SFc2_OptimalMPCInput_mdlInstanceStruct
  *chartInstance);
static const mxArray *c2_j_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_f_emlrt_marshallIn(SFc2_OptimalMPCInput_mdlInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_g_emlrt_marshallIn(SFc2_OptimalMPCInput_mdlInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_OptimalMPCInput_mdl, const
  char_T *c2_identifier);
static uint8_T c2_h_emlrt_marshallIn(SFc2_OptimalMPCInput_mdlInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_round(SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance,
  real_T c2_x[3]);
static void init_dsm_address_info(SFc2_OptimalMPCInput_mdlInstanceStruct
  *chartInstance);
  ...
  (SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_OptimalMPCInput_mdl = 0U;
}
  ...
  (SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal = chartInstance->c2_is_active_c2_OptimalMPCInput_mdl;
  ...
  (SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_flag_oob = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c2_u, 1)), "flag_oob");
  chartInstance->c2_is_active_c2_OptimalMPCInput_mdl = c2_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
     "is_active_c2_OptimalMPCInput_mdl");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_OptimalMPCInput_mdl(chartInstance);
  ...
  *chartInstance)
{
  ...
  c2_Nc = (real_T (*)[234])ssGetInputPortSignal(chartInstance->S, 5);
  c2_Gi = (real_T (*)[234])ssGetInputPortSignal(chartInstance->S, 4);
  c2_Fi = (real_T (*)[702])ssGetInputPortSignal(chartInstance->S, 3);
  c2_Kn = (real_T (*)[1872])ssGetInputPortSignal(chartInstance->S, 2);
  c2_Hn = (real_T (*)[5616])ssGetInputPortSignal(chartInstance->S, 1);
  c2_U = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_OptimalMPCInput_mdl(chartInstance);
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_OptimalMPCInput_mdlMachineNumber_,
  ...
  (SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance)
{
  ...
  c2_b_Nc = (real_T (*)[234])ssGetInputPortSignal(chartInstance->S, 5);
  c2_b_Gi = (real_T (*)[234])ssGetInputPortSignal(chartInstance->S, 4);
  c2_b_Fi = (real_T (*)[702])ssGetInputPortSignal(chartInstance->S, 3);
  c2_b_Kn = (real_T (*)[1872])ssGetInputPortSignal(chartInstance->S, 2);
  c2_b_Hn = (real_T (*)[5616])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c2_i8 = 0; c2_i8 < 5616; c2_i8++) {
    c2_Hn[c2_i8] = (*c2_b_Hn)[c2_i8];
  }

  for (c2_i9 = 0; c2_i9 < 1872; c2_i9++) {
    c2_Kn[c2_i9] = (*c2_b_Kn)[c2_i9];
  }

  for (c2_i10 = 0; c2_i10 < 702; c2_i10++) {
    c2_Fi[c2_i10] = (*c2_b_Fi)[c2_i10];
  }

  for (c2_i11 = 0; c2_i11 < 234; c2_i11++) {
    c2_Gi[c2_i11] = (*c2_b_Gi)[c2_i11];
  }

  for (c2_i12 = 0; c2_i12 < 234; c2_i12++) {
  ...
  do {
    ...
    if (c2_b_ireg < 234) {
      ...
      c2_d0 = c2_Nc[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("Nc", (int32_T)
        _SFD_INTEGER_CHECK("ireg", c2_ireg), 1, 234, 1, 0) - 1];
          ...
          c2_Hi[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("Hi", (int32_T)
            ...
            c2_Hn[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("Hn", (int32_T)
                    _SFD_INTEGER_CHECK("abspos + i - 1", (c2_abspos + c2_i) -
                     1.0), 1, 1872, 1, 0) + 1872 * ((int32_T)(real_T)
      ...
      while (c2_c_i <= c2_i21 - 1) {
        ...
        c2_Ki[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("Ki", (int32_T)
          ...
          "abspos + i - 1", (c2_abspos + c2_i) - 1.0), 1, 1872, 1, 0) - 1];
        c2_c_i++;
        _SF_MEX_LISTEN_FOR_CTRL_C(chartInstance->S);
      }
      ...
      c2_b_minreg = (int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("Fi", (int32_T)
        _SFD_INTEGER_CHECK("minreg", c2_minreg), 1, 234, 1, 0) - 1;
      for (c2_i28 = 0; c2_i28 < 3; c2_i28++) {
        c2_F[c2_i28] = c2_Fi[c2_b_minreg + 234 * c2_i28];
      }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance;
  chartInstance = (SFc2_OptimalMPCInput_mdlInstanceStruct *)chartInstanceVoid;
  ...
  *c2_inData)
{
  ...
  chartInstance = (SFc2_OptimalMPCInput_mdlInstanceStruct *)chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  for (c2_i37 = 0; c2_i37 < 234; c2_i37++) {
    c2_b_inData[c2_i37] = (*(real_T (*)[234])c2_inData)[c2_i37];
  }

  for (c2_i38 = 0; c2_i38 < 234; c2_i38++) {
    c2_u[c2_i38] = c2_b_inData[c2_i38];
  }

  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 0, 0U, 1U, 0U, 1, 234), FALSE);
  sf_mex_assign(&c2_mxArrayOutData, c2_y, FALSE);
  return c2_mxArrayOutData;
}
  ...
  *c2_inData)
{
  ...
  for (c2_i40 = 0; c2_i40 < 3; c2_i40++) {
    for (c2_i41 = 0; c2_i41 < 234; c2_i41++) {
      c2_b_inData[c2_i41 + c2_i39] = (*(real_T (*)[702])c2_inData)[c2_i41 +
        c2_i39];
    }
  ...
  for (c2_i43 = 0; c2_i43 < 3; c2_i43++) {
    for (c2_i44 = 0; c2_i44 < 234; c2_i44++) {
  ...
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 0, 0U, 1U, 0U, 2, 234, 3), FALSE);
  sf_mex_assign(&c2_mxArrayOutData, c2_y, FALSE);
  return c2_mxArrayOutData;
}
  ...
  *c2_inData)
{
  ...
  chartInstance = (SFc2_OptimalMPCInput_mdlInstanceStruct *)chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  for (c2_i45 = 0; c2_i45 < 1872; c2_i45++) {
    c2_b_inData[c2_i45] = (*(real_T (*)[1872])c2_inData)[c2_i45];
  }

  for (c2_i46 = 0; c2_i46 < 1872; c2_i46++) {
    c2_u[c2_i46] = c2_b_inData[c2_i46];
  }

  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 0, 0U, 1U, 0U, 1, 1872), FALSE);
  sf_mex_assign(&c2_mxArrayOutData, c2_y, FALSE);
  return c2_mxArrayOutData;
}
  ...
  *c2_inData)
{
  ...
  for (c2_i48 = 0; c2_i48 < 3; c2_i48++) {
    for (c2_i49 = 0; c2_i49 < 1872; c2_i49++) {
      c2_b_inData[c2_i49 + c2_i47] = (*(real_T (*)[5616])c2_inData)[c2_i49 +
        c2_i47];
    }
  ...
  for (c2_i51 = 0; c2_i51 < 3; c2_i51++) {
    for (c2_i52 = 0; c2_i52 < 1872; c2_i52++) {
  ...
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 0, 0U, 1U, 0U, 2, 1872, 3),
                FALSE);
  sf_mex_assign(&c2_mxArrayOutData, c2_y, FALSE);
  return c2_mxArrayOutData;
}
...
const mxArray *sf_c2_OptimalMPCInput_mdl_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_OptimalMPCInput_mdl), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_OptimalMPCInput_mdl);
  return c2_y;
}
...
void sf_c2_OptimalMPCInput_mdl_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1247789017U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2498089766U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2264804679U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3211684302U);
}

mxArray *sf_c2_OptimalMPCInput_mdl_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("BKo7cJ3mdKV0mshmkbwtuB");
...
mxArray *sf_c2_OptimalMPCInput_mdl_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c2_OptimalMPCInput_mdl(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"U\",},{M[1],M[12],T\"flag_oob\",},{M[8],M[0],T\"is_active_c2_OptimalMPCInput_mdl\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_OptimalMPCInput_mdl_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance;
    chartInstance = (SFc2_OptimalMPCInput_mdlInstanceStruct *) ((ChartInfoStruct
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _OptimalMPCInput_mdlMachineNumber_,
           2,
           1,
           1,
           10,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_OptimalMPCInput_mdlMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_OptimalMPCInput_mdlMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _OptimalMPCInput_mdlMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "OIe6V6lSadSFHPkzCmzD1E";
}

static void sf_opaque_initialize_c2_OptimalMPCInput_mdl(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_OptimalMPCInput_mdlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_OptimalMPCInput_mdl
    ((SFc2_OptimalMPCInput_mdlInstanceStruct*) chartInstanceVar);
  initialize_c2_OptimalMPCInput_mdl((SFc2_OptimalMPCInput_mdlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_OptimalMPCInput_mdl(void *chartInstanceVar)
{
  enable_c2_OptimalMPCInput_mdl((SFc2_OptimalMPCInput_mdlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_OptimalMPCInput_mdl(void *chartInstanceVar)
{
  disable_c2_OptimalMPCInput_mdl((SFc2_OptimalMPCInput_mdlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_OptimalMPCInput_mdl(void *chartInstanceVar)
{
  sf_c2_OptimalMPCInput_mdl((SFc2_OptimalMPCInput_mdlInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_OptimalMPCInput_mdl(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_OptimalMPCInput_mdl
    ((SFc2_OptimalMPCInput_mdlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_OptimalMPCInput_mdl();/* state var info */
...
extern void sf_internal_set_sim_state_c2_OptimalMPCInput_mdl(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_OptimalMPCInput_mdl((SFc2_OptimalMPCInput_mdlInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_OptimalMPCInput_mdl(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c2_OptimalMPCInput_mdl(S);
}

static void sf_opaque_set_sim_state_c2_OptimalMPCInput_mdl(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_OptimalMPCInput_mdl(S, st);
}

static void sf_opaque_terminate_c2_OptimalMPCInput_mdl(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_OptimalMPCInput_mdlInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_OptimalMPCInput_mdl_optimization_info();
    }

    finalize_c2_OptimalMPCInput_mdl((SFc2_OptimalMPCInput_mdlInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_OptimalMPCInput_mdl((SFc2_OptimalMPCInput_mdlInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_OptimalMPCInput_mdl(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_OptimalMPCInput_mdl
      ((SFc2_OptimalMPCInput_mdlInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_OptimalMPCInput_mdl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_OptimalMPCInput_mdl_optimization_info();
  ...
  ssSetChecksum0(S,(3887249284U));
  ssSetChecksum1(S,(2677495499U));
  ssSetChecksum2(S,(1998538645U));
  ssSetChecksum3(S,(4182939523U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_OptimalMPCInput_mdl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_OptimalMPCInput_mdl(SimStruct *S)
{
  SFc2_OptimalMPCInput_mdlInstanceStruct *chartInstance;
  chartInstance = (SFc2_OptimalMPCInput_mdlInstanceStruct *)utMalloc(sizeof
    (SFc2_OptimalMPCInput_mdlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_OptimalMPCInput_mdlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_OptimalMPCInput_mdl;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_OptimalMPCInput_mdl;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_OptimalMPCInput_mdl;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_OptimalMPCInput_mdl;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_OptimalMPCInput_mdl;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_OptimalMPCInput_mdl;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_OptimalMPCInput_mdl;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_OptimalMPCInput_mdl;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_OptimalMPCInput_mdl;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_OptimalMPCInput_mdl;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_OptimalMPCInput_mdl;
...
void c2_OptimalMPCInput_mdl_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_OptimalMPCInput_mdl(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_OptimalMPCInput_mdl(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_OptimalMPCInput_mdl(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_OptimalMPCInput_mdl_method_dispatcher.\n"
