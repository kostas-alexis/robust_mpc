  ...
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==1) {
    c1_Robust_MPC_Library_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"Robust_MPC_Library")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(616006328U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1915913238U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2291074805U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(362049451U);
        } else if (nrhs==4) {
          ...
          switch (chartFileNumber) {
           case 1:
            {
              extern void sf_c1_Robust_MPC_Library_get_check_sum(mxArray *plhs[]);
              sf_c1_Robust_MPC_Library_get_check_sum(plhs);
              break;
            }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "TH6P2bRmSoEZUxTdhMIzsD") == 0) {
          extern mxArray *sf_c1_Robust_MPC_Library_get_autoinheritance_info(void);
          plhs[0] = sf_c1_Robust_MPC_Library_get_autoinheritance_info();
          break;
        }
     ...
     case 1:
      {
        extern const mxArray
          *sf_c1_Robust_MPC_Library_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c1_Robust_MPC_Library_get_eml_resolved_functions_info();
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "1Oi5e3q6WnmJvt7aW2pcUG") == 0) {
          extern mxArray *sf_c1_Robust_MPC_Library_third_party_uses_info(void);
          plhs[0] = sf_c1_Robust_MPC_Library_third_party_uses_info();
          break;
        }
      }
