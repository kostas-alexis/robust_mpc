...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_ASLquad_onboardRobustMPC_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Robust_MPC_Library_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ASLquad_onboardRobustMPC_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_ASLquad_onboardRobustMPC_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "ASLquad_onboardRobustMPC") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ASLquad_onboardRobustMPC_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_ASLquad_onboardRobustMPC_third_party_uses_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "ASLquad_onboardRobustMPC") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ASLquad_onboardRobustMPC_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_ASLquad_onboardRobustMPC_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "ASLquad_onboardRobustMPC") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_ASLquad_onboardRobustMPC_get_eml_resolved_functions_info(nlhs,plhs,
      2,newRhs);
  }
...
extern unsigned int sf_ASLquad_onboardRobustMPC_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"ASLquad_onboardRobustMPC")) {
    return(sf_ASLquad_onboardRobustMPC_method_dispatcher(simstructPtr,
...
extern void ASLquad_onboardRobustMPC_terminator(void);
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    ASLquad_onboardRobustMPC_terminator();
...
extern void ASLquad_onboardRobustMPC_initializer(void);
extern void Robust_MPC_Library_initializer(void);
extern void ASLquad_onboardRobustMPC_register_exported_symbols(SimStruct* S);
extern void Robust_MPC_Library_register_exported_symbols(SimStruct* S);
extern void ASLquad_onboardRobustMPC_debug_initialize(struct
...
{
  ASLquad_onboardRobustMPC_register_exported_symbols(S);
