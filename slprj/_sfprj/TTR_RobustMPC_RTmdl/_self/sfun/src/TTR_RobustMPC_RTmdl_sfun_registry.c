...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_TTR_RobustMPC_RTmdl_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Robust_MPC_Library_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_TTR_RobustMPC_RTmdl_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_TTR_RobustMPC_RTmdl_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "TTR_RobustMPC_RTmdl") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_TTR_RobustMPC_RTmdl_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_TTR_RobustMPC_RTmdl_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "TTR_RobustMPC_RTmdl") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_TTR_RobustMPC_RTmdl_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_TTR_RobustMPC_RTmdl_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "TTR_RobustMPC_RTmdl") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_TTR_RobustMPC_RTmdl_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_TTR_RobustMPC_RTmdl_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"TTR_RobustMPC_RTmdl")) {
    return(sf_TTR_RobustMPC_RTmdl_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void TTR_RobustMPC_RTmdl_terminator(void);
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    TTR_RobustMPC_RTmdl_terminator();
...
extern void TTR_RobustMPC_RTmdl_initializer(void);
extern void Robust_MPC_Library_initializer(void);
extern void TTR_RobustMPC_RTmdl_register_exported_symbols(SimStruct* S);
extern void Robust_MPC_Library_register_exported_symbols(SimStruct* S);
extern void TTR_RobustMPC_RTmdl_debug_initialize(struct SfDebugInstanceStruct*);
...
{
  TTR_RobustMPC_RTmdl_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      TTR_RobustMPC_RTmdl_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    TTR_RobustMPC_RTmdl_initializer();
    if (!simModeIsRTWGen) {
