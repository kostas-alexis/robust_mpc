  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"Robust_MPC_Library")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1501727346U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(797201233U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1685907315U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3249590446U);
        } else if (nrhs==4) {
...
mxArray* load_Robust_MPC_Library_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "Robust_MPC_Library", "some_testing");
