  ...
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==1) {
    if (!strcmp(specsCksum, "BqLEbDSqkPIlCfV7CVGezF")) {
      c1_BqLEbDSqkPIlCfV7CVGezF_Robust_MPC_Library_method_dispatcher
    ...
    if (!strcmp(specsCksum, "Sao0Rb2K8eEHuTEJX93O2C")) {
      c1_Sao0Rb2K8eEHuTEJX93O2C_Robust_MPC_Library_method_dispatcher
        (simstructPtr, method, data);
      return 1;
    }
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"Robust_MPC_Library")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2763914077U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(773935718U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3694168628U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2034576605U);
        } else if (nrhs==4) {
          ...
          switch (chartFileNumber) {
           case 1:
            {
              extern void
                sf_c1_Sao0Rb2K8eEHuTEJX93O2C_Robust_MPC_Library_get_check_sum
                (mxArray *plhs[]);
              sf_c1_Sao0Rb2K8eEHuTEJX93O2C_Robust_MPC_Library_get_check_sum(plhs);
              break;
            }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "r0X7nTRdJt6rdWAilMJmWG") == 0) {
          extern mxArray
            *sf_c1_BqLEbDSqkPIlCfV7CVGezF_Robust_MPC_Library_get_autoinheritance_info
            (void);
          plhs[0] =
            sf_c1_BqLEbDSqkPIlCfV7CVGezF_Robust_MPC_Library_get_autoinheritance_info
            ();
        ...
        if (strcmp(aiChksum, "27jFvmc2hvITKB7ZES8HZC") == 0) {
          extern mxArray
            *sf_c1_Sao0Rb2K8eEHuTEJX93O2C_Robust_MPC_Library_get_autoinheritance_info
            (void);
          plhs[0] =
            sf_c1_Sao0Rb2K8eEHuTEJX93O2C_Robust_MPC_Library_get_autoinheritance_info
            ();
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "BqLEbDSqkPIlCfV7CVGezF") == 0) {
          extern mxArray
            *sf_c1_BqLEbDSqkPIlCfV7CVGezF_Robust_MPC_Library_third_party_uses_info
            (void);
          plhs[0] =
            sf_c1_BqLEbDSqkPIlCfV7CVGezF_Robust_MPC_Library_third_party_uses_info
            ();
        ...
        if (strcmp(tpChksum, "Sao0Rb2K8eEHuTEJX93O2C") == 0) {
          extern mxArray
            *sf_c1_Sao0Rb2K8eEHuTEJX93O2C_Robust_MPC_Library_third_party_uses_info
            (void);
          plhs[0] =
            sf_c1_Sao0Rb2K8eEHuTEJX93O2C_Robust_MPC_Library_third_party_uses_info
            ();
