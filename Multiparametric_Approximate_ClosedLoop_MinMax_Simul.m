function [x_state_k,sol_x_mp] = Multiparametric_Approximate_ClosedLoop_MinMax_Simul(add_usys_d,x_state,Y_x_Limit,U_x_bounds,W_x_bounds,Q,R,N,norm_type,Simul_Steps)
%
%   Syntax:
